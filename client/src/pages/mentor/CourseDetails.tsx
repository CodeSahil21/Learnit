...
import { Edit, Users, Plus, UserPlus, Eye, Search } from 'lucide-react'
          ...
          <div className="flex space-x-3">
            <Dialog open={assignDialogOpen} onOpenChange={setAssignDialogOpen}>
              <DialogTrigger asChild>
                <Button className="bg-white text-blue-600 hover:bg-gray-100 !text-blue-600">
            ...
            <Button asChild className="bg-white text-blue-600 hover:bg-gray-100 !text-blue-600">
              <Link to={`/mentor/courses/${courseId}/edit`} className="!text-blue-600">
            ...
            <CardContent>
              {currentCourse.chapters && currentCourse.chapters.length > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-4">Start adding chapters to build your course content</p>
                  <Button onClick={() => setShowAddChapterModal(true)} className="!text-white">
                    Add First Chapter
                  </Button>
                </div>
              )}
